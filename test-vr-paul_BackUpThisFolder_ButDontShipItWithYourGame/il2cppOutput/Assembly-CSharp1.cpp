...
struct TestCameraChange_t95D1F52ABE2B941C464C521C932EB99A96EBBE3D;
// Crest.TestDynamicResolution
struct TestDynamicResolution_t4417F812C1DA1B5AF1E6646F1701E535962A6A2D;
...
// Crest.TestCameraChange
struct TestCameraChange_t95D1F52ABE2B941C464C521C932EB99A96EBBE3D  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
...
// Crest.TestDynamicResolution
struct TestDynamicResolution_t4417F812C1DA1B5AF1E6646F1701E535962A6A2D  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
...
// T[] UnityEngine.GameObject::GetComponentsInChildren<UnityEngine.Camera>(System.Boolean)
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void Crest.TestCameraChange::OnEnable()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TestCameraChange_OnEnable_m37C831A76BC137A79D1F33A4A990CAE329FA81A6 (TestCameraChange_t95D1F52ABE2B941C464C521C932EB99A96EBBE3D* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	{
		// if (_cameras.Count > 0)
		List_1_tD2FA3273746E404D72561E8324608D18B52B533E* L_0 = __this->____cameras_4;
		NullCheck(L_0);
		int32_t L_1;
...
IL_000f:
	{
		...
		L_3 = Scene_GetRootGameObjects_mFDE0BF9EA926F30EC9AE71F33E0AE4D5D4EC5C5B((&V_2), NULL);
		V_0 = L_3;
		V_1 = 0;
		goto IL_0069;
	}
...
IL_0021:
	{
		...
		L_8 = GameObject_GetComponentsInChildren_TisCamera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184_mDB567070B532F76D55A250B4C436DC209041DED1(L_7, (bool)1, GameObject_GetComponentsInChildren_TisCamera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184_mDB567070B532F76D55A250B4C436DC209041DED1_RuntimeMethod_var);
		V_3 = L_8;
		V_4 = 0;
		goto IL_005e;
	}
...
IL_0030:
	{
		// foreach (var camera in gameObject.GetComponentsInChildren<Camera>(true))
		CameraU5BU5D_t1506EBA524A07AD1066D6DD4D7DFC6721F1AC26B* L_9 = V_3;
		int32_t L_10 = V_4;
		NullCheck(L_9);
		int32_t L_11 = L_10;
		...
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_13 = V_5;
		NullCheck(L_13);
		int32_t L_14;
	...
	{
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_15 = V_5;
		NullCheck(L_15);
		int32_t L_16;
	...
	{
		// _cameras.Add(camera);
		List_1_tD2FA3273746E404D72561E8324608D18B52B533E* L_17 = __this->____cameras_4;
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_18 = V_5;
		NullCheck(L_17);
		List_1_Add_m9BE0CD6DB63BFCBCBD5619618748924143F1AFAD_inline(L_17, L_18, List_1_Add_m9BE0CD6DB63BFCBCBD5619618748924143F1AFAD_RuntimeMethod_var);
	}
...
IL_005e:
	{
		// foreach (var camera in gameObject.GetComponentsInChildren<Camera>(true))
		int32_t L_20 = V_4;
		CameraU5BU5D_t1506EBA524A07AD1066D6DD4D7DFC6721F1AC26B* L_21 = V_3;
		NullCheck(L_21);
...
// System.Void Crest.TestCameraChange::Update()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TestCameraChange_Update_m62D55D38D975099FDB76AE7FFB4D55651102AE6B (TestCameraChange_t95D1F52ABE2B941C464C521C932EB99A96EBBE3D* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	Enumerator_t93D203A9A9D816BAA70CE6E56C8D9994EF3AFEA9 V_1;
...
IL_0008:
	{
		...
		L_2 = Keyboard_get_cKey_mF3B1FB6F0BF230C757F5660432BF869253BDFFC7(L_1, NULL);
		NullCheck(L_2);
		bool L_3;
	...
	}
	{
		...
		List_1_tD2FA3273746E404D72561E8324608D18B52B533E* L_4 = __this->____cameras_4;
		List_1_tD2FA3273746E404D72561E8324608D18B52B533E* L_5 = __this->____cameras_4;
		NullCheck(L_5);
		int32_t L_6;
		L_6 = List_1_get_Count_mDCDDC4E9E15CD83C00D4CC32F79830261769F65C_inline(L_5, List_1_get_Count_mDCDDC4E9E15CD83C00D4CC32F79830261769F65C_RuntimeMethod_var);
		NullCheck(L_4);
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_7;
		L_7 = List_1_get_Item_m7CEE3A6E144C8D86DE6490620206FAB13432ACF6(L_4, ((int32_t)il2cpp_codegen_subtract(L_6, 1)), List_1_get_Item_m7CEE3A6E144C8D86DE6490620206FAB13432ACF6_RuntimeMethod_var);
		V_0 = L_7;
		// foreach (var current in _cameras)
		List_1_tD2FA3273746E404D72561E8324608D18B52B533E* L_8 = __this->____cameras_4;
		NullCheck(L_8);
		Enumerator_t93D203A9A9D816BAA70CE6E56C8D9994EF3AFEA9 L_9;
		L_9 = List_1_GetEnumerator_m7D0CB3BF9DA3F624753AE63D1292B99B42AB4170(L_8, List_1_GetEnumerator_m7D0CB3BF9DA3F624753AE63D1292B99B42AB4170_RuntimeMethod_var);
		V_1 = L_9;
	}
	{
...
FINALLY_007c:
			{// begin finally (depth: 1)
				Enumerator_Dispose_m952D668DE163B9341CCEDC01C0C12525996D6624((&V_1), Enumerator_Dispose_m952D668DE163B9341CCEDC01C0C12525996D6624_RuntimeMethod_var);
				return;
			}// end finally (depth: 1)
		});
		try
...
IL_0040_1:
			{
				...
				L_10 = Enumerator_get_Current_m6AB352F2089737A72DC284B801157073F82C1A5F_inline((&V_1), Enumerator_get_Current_m6AB352F2089737A72DC284B801157073F82C1A5F_RuntimeMethod_var);
				V_2 = L_10;
...
IL_0071_1:
			{
				// foreach (var current in _cameras)
				bool L_19;
				L_19 = Enumerator_MoveNext_mE9EB9A31EBEC90FA3E951E245AD2F4A3585DB16C((&V_1), Enumerator_MoveNext_mE9EB9A31EBEC90FA3E951E245AD2F4A3585DB16C_RuntimeMethod_var);
				if (L_19)
				{
					goto IL_0040_1;
				}
...
// System.Void Crest.TestCameraChange::.ctor()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TestCameraChange__ctor_mD52DCFB3BF70B467926C4E65F4D51834A7C81198 (TestCameraChange_t95D1F52ABE2B941C464C521C932EB99A96EBBE3D* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	}
	{
		...
		__this->____cameras_4 = L_0;
		Il2CppCodeGenWriteBarrier((void**)(&__this->____cameras_4), (void*)L_0);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void Crest.TestDynamicResolution::OnDisable()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TestDynamicResolution_OnDisable_m9A5E8D785C850BEB4B6FACCB064AA1FDBF2FF731 (TestDynamicResolution_t4417F812C1DA1B5AF1E6646F1701E535962A6A2D* __this, const RuntimeMethod* method) 
{
	{
...
// System.Void Crest.TestDynamicResolution::Update()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TestDynamicResolution_Update_mDD70BC4A8F514D95D7D151C1681BD19840F7F6F9 (TestDynamicResolution_t4417F812C1DA1B5AF1E6646F1701E535962A6A2D* __this, const RuntimeMethod* method) 
{
	{
		// if (_currentResolutionScale != _resolutionScale)
		float L_0 = __this->____currentResolutionScale_5;
		float L_1 = __this->____resolutionScale_4;
	...
	}
	{
		...
		float L_2 = __this->____resolutionScale_4;
		float L_3 = __this->____resolutionScale_4;
		ScalableBufferManager_ResizeBuffers_m3E75B5044AD106F7413273B884D313FEE11FEA0A(L_2, L_3, NULL);
		// _currentResolutionScale = _resolutionScale;
		float L_4 = __this->____resolutionScale_4;
		__this->____currentResolutionScale_5 = L_4;
	}
...
// System.Void Crest.TestDynamicResolution::.ctor()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TestDynamicResolution__ctor_mCCA0EAAFAEFE4543CFB93DEDB84D16C5CD8E5CE0 (TestDynamicResolution_t4417F812C1DA1B5AF1E6646F1701E535962A6A2D* __this, const RuntimeMethod* method) 
{
	{
		// [SerializeField, Range(0.01f, 1f)] float _resolutionScale = 1f;
		__this->____resolutionScale_4 = (1.0f);
		// float _currentResolutionScale = 1f;
		__this->____currentResolutionScale_5 = (1.0f);
		MonoBehaviour__ctor_m592DB0105CA0BC97AA1C5F4AD27B12D68A3B7C1E(__this, NULL);
		return;
	}
}
